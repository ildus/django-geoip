...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'City.country_name'
        db.add_column(u'django_geoip_city', 'country_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'City.country_name'
        db.delete_column(u'django_geoip_city', 'country_name')
